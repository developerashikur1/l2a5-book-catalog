...
router.put("/:id", books_controller_1.BookController.commentOnBook);
router.patch("/:id", (0, validateRequest_1.default)(books_validation_1.BookValidation.editBookZodSchema), books_controller_1.BookController.editBook);
